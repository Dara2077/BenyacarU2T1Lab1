public class RectangleRunner {
    public static void main(String[] args) {
        ...
        rect1.printPerimeter(); // calling a different method on the object
        ...
        rect2.printPerimeter(); // calling a different method on the object

        // creating my own instance/object from the Rectangle class
        Rectangle rect3 = new Rectangle(3, 8);
        rect3.printArea(); // calling a method on the object;
        rect3.printPerimeter(); // calling a different method on the object
